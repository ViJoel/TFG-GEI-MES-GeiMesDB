...
THEME = {
    ...
    # Primary
    "primary": DARK_BLUE,
    "primary_hover": DARK_BLUE_HOVER,
    "primary_pressed": DARK_BLUE_PRESSED,
    "primary_disabled": DARK_BLUE_DISABLED,
    # Secondary
    "secondary": DARK_PURPLE,
    "secondary_hover": DARK_PURPLE_HOVER,
    "secondary_pressed": DARK_PURPLE_PRESSED,
    "secondary_disabled": DARK_PURPLE_DISABLED,
    # Danger
    "danger": RED,
    ...
    # Warning
    "warning": DARK_YELLOW,
    "warning_hover": DARK_YELLOW_HOVER,
    "warning_pressed": DARK_YELLOW_PRESSED,
    "warning_disabled": DARK_YELLOW_DISABLED,
    # Success
    "success": DARK_GREEN,
    "success_hover": DARK_GREEN_HOVER,
    "success_pressed": DARK_GREEN_PRESSED,
    "success_disabled": DARK_GREEN_DISABLED,
    # Error
    "error": DARK_RED,
    "error_hover": DARK_RED_HOVER,
    "error_pressed": DARK_RED_PRESSED,
    "error_disabled": DARK_RED_DISABLED,
    # Info
    "info": DARK_CYAN,
    "info_hover": DARK_CYAN_HOVER,
    "info_pressed": DARK_CYAN_PRESSED,
    "info_disabled": DARK_CYAN_DISABLED,
    # Accent
    "accent": DARK_ORANGE,
    "accent_hover": DARK_ORANGE_HOVER,
    "accent_pressed": DARK_ORANGE_PRESSED,
    "accent_disabled": DARK_ORANGE_DISABLED,
    # Text
    "text": GRAY_900,
    "text_hover": BLACK,
    "text_pressed": GRAY_800,
...
THEME.update(
    {
        ...
        "button_background_color_hover": GRAY_100,
        "button_background_color_pressed": GRAY_150,
        "button_background_color_disabled": GRAY_100,
        "button_border_color": GRAY_300,
        "button_border_color_hover": GRAY_400,
        "button_border_color_pressed": GRAY_450,
        "button_border_color_disabled": GRAY_200,
        "button_color": GRAY_900,
        "button_color_hover": BLACK,
        "button_color_pressed": BLACK,
        "button_color_disabled": GRAY_400,
        # Primary
        ...
        "button_primary_color_hover": WHITE,
        "button_primary_color_pressed": WHITE,
        ...
        "button_secondary_color_hover": WHITE,
        "button_secondary_color_pressed": WHITE,
        ...
        "button_danger_color_hover": WHITE,
        "button_danger_color_pressed": WHITE,
        ...
        "button_accent_color_hover": WHITE,
        "button_accent_color_pressed": WHITE,
...
THEME.update(
    {
        # Formulario
        "connection_form_background_color": WHITE,
        ...
        # Inputs
        "connection_form_input_background_color": WHITE,
        "connection_form_input_background_color_hover": GRAY_50,
        "connection_form_input_background_color_focus": WHITE,
        "connection_form_input_border_color": GRAY_300,
        "connection_form_input_border_color_hover": GRAY_400,
...
THEME.update(
    {
        "connection_item_connected_background_color": LIGHT_GREEN_HOVER,
        "connection_item_connected_background_color_hover": LIGHT_GREEN,
        "connection_item_connected_selected_background_color": GREEN,
        "connection_item_disconnected_background_color": TRANSPARENT,
        "connection_item_disconnected_background_color_hover": GRAY_100,
        "connection_item_disconnected_selected_background_color": GRAY_150,
        "connections_list_background_color": WHITE,
        "connections_list_border_color": GRAY_300,
    }
)
...
THEME.update(
    {
        ...
        "button_add_connection_color_hover": WHITE,
        "button_add_connection_color_pressed": WHITE,
        "button_add_connection_color_disabled": GREEN_DISABLED,
        # Edit connection
        "button_edit_connection_background_color": WHITE,
        "button_edit_connection_background_color_hover": ORANGE_HOVER,
        "button_edit_connection_background_color_pressed": ORANGE_PRESSED,
        "button_edit_connection_background_color_disabled": GRAY_100,
        ...
        "button_edit_connection_color_hover": WHITE,
        "button_edit_connection_color_pressed": WHITE,
        "button_edit_connection_color_disabled": ORANGE_DISABLED,
        # Delete connection
        "button_delete_connection_background_color": WHITE,
        "button_delete_connection_background_color_hover": RED_HOVER,
        "button_delete_connection_background_color_pressed": RED_PRESSED,
        "button_delete_connection_background_color_disabled": GRAY_100,
        ...
        "button_delete_connection_color_hover": WHITE,
        "button_delete_connection_color_pressed": WHITE,
        "button_delete_connection_color_disabled": RED_DISABLED,
        # Connect
        "button_connect_background_color": WHITE,
        "button_connect_background_color_hover": BLUE_HOVER,
        "button_connect_background_color_pressed": BLUE_PRESSED,
        "button_connect_background_color_disabled": GRAY_100,
        ...
        "button_connect_color_hover": WHITE,
        "button_connect_color_pressed": WHITE,
        "button_connect_color_disabled": BLUE_DISABLED,
        # Disconnect
        "button_disconnect_background_color": WHITE,
        "button_disconnect_background_color_hover": PURPLE_HOVER,
        "button_disconnect_background_color_pressed": PURPLE_PRESSED,
        "button_disconnect_background_color_disabled": GRAY_100,
        "button_disconnect_border_color": PURPLE,
        "button_disconnect_border_color_hover": PURPLE_HOVER,
        "button_disconnect_border_color_pressed": PURPLE_PRESSED,
        "button_disconnect_border_color_disabled": PURPLE_DISABLED,
        "button_disconnect_color": PURPLE,
        "button_disconnect_color_hover": WHITE,
        "button_disconnect_color_pressed": WHITE,
        "button_disconnect_color_disabled": PURPLE_DISABLED,
    }
)
...
THEME.update(
    {
        ...
        "connection_queries_history_inputs_background_color": WHITE,
        "connection_queries_history_inputs_border_color": THEME["primary"],
        # Inputs
        "connection_queries_history_date_input_background_color": WHITE,
        "connection_queries_history_date_input_background_color_hover": GRAY_50,
        "connection_queries_history_date_input_background_color_focus": WHITE,
        "connection_queries_history_date_input_border_color": GRAY_300,
        "connection_queries_history_date_input_border_color_hover": GRAY_400,
        ...
        "connection_queries_history_date_input_calendar_background_color": WHITE,
        ...
        "connection_queries_history_date_input_calendar_year_input_menu_background_color": WHITE,
        ...
        "connection_queries_history_date_input_calendar_year_input_menu_item_background_color_hover": BLUE_RGBA_25,
        ...
        "connection_queries_history_date_input_calendar_arrow_button_background_color_hover": BLUE_RGBA_25,
        "connection_queries_history_date_input_calendar_arrow_button_background_color_pressed": BLUE_RGBA_50,
        # Calendario desplegable: Celdas de los días
        "connection_queries_history_date_input_calendar_cell_background_color_hover": BLUE_RGBA_25,
        "connection_queries_history_date_input_calendar_cell_background_color_selected": BLUE_RGBA_50,
        # Tipografía
...
THEME.update(
    {
        "files_list_background_color": WHITE,
...
THEME.update(
    {
        "files_list_item_background_color": "rgba(76, 141, 218, 0.10)",
        "files_list_item_background_color_hover": "rgba(76, 141, 218, 0.20)",
        "files_list_item_background_color_selected": "rgba(76, 141, 218, 0.30)",
        "files_list_item_color": THEME["secondary"],
        # Botón
        "files_list_item_close_button_background_color_hover": "rgba(149, 191, 240, 0.25)",
        "files_list_item_close_button_background_color_pressed": "rgba(149, 191, 240, 0.50)",
    }
)
...
THEME.update(
    {
        # Panel
        "navigation_tree_background_color": WHITE,
        "navigation_tree_border_color": THEME["primary"],
        # Barra de búsqueda
        "navigation_tree_search_bar_background_color": WHITE,
        "navigation_tree_search_bar_border_color": GRAY_300,
        "navigation_tree_search_bar_color": THEME["text"],
        "navigation_tree_search_bar_background_color_hover": GRAY_50,
        "navigation_tree_search_bar_border_color_hover": GRAY_400,
        "navigation_tree_search_bar_color_hover": THEME["text_hover"],
        "navigation_tree_search_bar_background_color_focus": WHITE,
        "navigation_tree_search_bar_border_color_focus": THEME["primary"],
        "navigation_tree_search_bar_color_focus": THEME["primary"],
        # Botón de refresco
        "navigation_tree_refresh_button_background_color": WHITE,
        "navigation_tree_refresh_button_border_color": THEME["accent"],
        "navigation_tree_refresh_button_color": THEME["accent"],
        "navigation_tree_refresh_button_background_color_hover": ORANGE_RGBA_25,
        "navigation_tree_refresh_button_background_color_pressed": ORANGE_RGBA_50,
        # Iconos
        "navigation_tree_icon_color": GRAY_500,
        "navigation_tree_column_icon_color": "#607D8B",
        "navigation_tree_constraint_icon_color": "#1565C0",
        "navigation_tree_constraint_fk_icon_color": "#29B6F6",
        "navigation_tree_constraint_nullable_icon_color": GRAY_400,
        "navigation_tree_constraint_pk_icon_color": "#F9A825",
        "navigation_tree_constraint_unique_icon_color": "#EF5350",
        "navigation_tree_constraint_check_icon_color": "#43A047",
        "navigation_tree_folder_icon_color": "#FBC02D",
        "navigation_tree_index_icon_color": PURPLE,
        "navigation_tree_materialized_view_icon_color": BLUE,
        "navigation_tree_table_icon_color": BLUE,
        "navigation_tree_view_icon_color": CYAN,
        # Items
        "navigation_tree_item_background_color_hover": GRAY_100,
        "navigation_tree_item_background_color_selected": BLUE_RGBA_25,
        "navigation_tree_item_background_color_selected_active": BLUE_RGBA_50,
        "navigation_tree_item_background_color_selected_not_active": GRAY_150,
    }
)
...
THEME.update(
    {
        "navigation_tree_context_menu_background_color": WHITE,
        "navigation_tree_context_menu_border_color": THEME["primary"],
        "navigation_tree_context_menu_color": THEME["text"],
        "navigation_tree_context_menu_item_selected_background_color": BLUE_RGBA_25,
        "navigation_tree_context_menu_item_selected_color": THEME["secondary"],
        "navigation_tree_context_menu_separator_color": GRAY_300,
    }
)
...
THEME.update(
    {
        # Default
        "notification_background_color": WHITE,
        "notification_border_color": GRAY_300,
        "notification_color": THEME["text"],
        # Success
        "notification_success_background_color": LIGHT_GREEN,
        "notification_success_border_color": DARK_GREEN,
        "notification_success_color": DARK_GREEN,
        # Error
        "notification_error_background_color": LIGHT_RED,
        "notification_error_border_color": DARK_RED,
        "notification_error_color": DARK_RED,
        # Info
        "notification_info_background_color": LIGHT_BLUE,
        "notification_info_border_color": DARK_BLUE,
        "notification_info_color": DARK_BLUE,
        # Warning
...
THEME.update(
    {
        # Dialog
        "rename_file_dialog_background_color": WHITE,
        "rename_file_dialog_border_color": GRAY_300,
        "rename_file_dialog_color": THEME["text"],
        # Input
        "rename_file_dialog_input_background_color": WHITE,
        "rename_file_dialog_input_background_color_hover": GRAY_50,
        "rename_file_dialog_input_border_color": GRAY_300,
        "rename_file_dialog_input_border_color_hover": THEME["primary"],
...
THEME.update(
    {
        "scrollbar_background_color": GRAY_100,
...
THEME.update(
    {
        "session_queries_history_background_color": WHITE,
        "session_queries_history_border_color": THEME["primary"],
    }
)
...
THEME.update(
    {
        ...
        "session_queries_history_item_background_hover_color": GRAY_100,
        "session_queries_history_item_background_selected_color": BLUE_RGBA_25,
...
THEME.update(
    {
        ...
        "splitter_background_color_hover": THEME["primary"],
        "splitter_background_color_pressed": THEME["primary_hover"],
    }
)
...
THEME.update(
    {
        "sql_completer_background_color": WHITE,
        "sql_completer_border_color": THEME["primary"],
        "sql_completer_selection_background_color": BLUE_RGBA_25,
        "sql_completer_selection_color": THEME["text"],
    }
)
...
THEME.update(
    {
        # Editor
        "sql_editor_background_color": WHITE,
        "sql_editor_border_color": THEME["primary"],
        "sql_editor_border_color_focused": THEME["secondary"],
        "sql_editor_color": THEME["text"],
        # Tipografía
        "sql_editor_font_family": "'JetBrains Mono'",
        "sql_editor_font_size": "14px",
        # Línea actual
        "sql_editor_current_line_background_color": GRAY_50,
        # Área de números de línea
        "sql_editor_line_number_background_color": GRAY_100,
        "sql_editor_line_number_color": GRAY_400,
...
THEME.update(
    {
        "sql_boolean_color": BLUE,
        "sql_column_color": GRAY_900,
        "sql_comment_color": GRAY_400,
        "sql_constant_color": BLUE,
        "sql_constraint_color": RED,
        "sql_function_color": PURPLE,
        "sql_identifier_color": GRAY_900,
        "sql_index_color": DARK_PURPLE,
        "sql_keyword_color": DARK_BLUE,
        "sql_null_color": BLUE,
        "sql_number_color": GRAY_900,
        "sql_parameter_color": PURPLE,
        "sql_string_color": DARK_GREEN,
        "sql_symbol_color": GRAY_700,
        "sql_table_color": CYAN,
        "sql_type_color": CYAN,
        "sql_variable_color": PURPLE,
        "sql_view_color": BLUE,
    }
)
...
THEME.update(
    {
        ...
        # Cabecera
        "table_header_background_color": GRAY_100,
        # Celdas de la cabecera
        "table_header_cell_background_color": THEME["primary"],
        "table_header_cell_color": WHITE,
        # Celdas de la tabla
        "table_cell_background_color_hover": "rgba(76, 141, 218, 0.10)",
        "table_cell_selected_background_color": BLUE_RGBA_25,
        "table_cell_selected_color": THEME["text"],
        "table_cell_modified_background_color": LIGHT_YELLOW,
        "table_cell_modified_color": GRAY_900,
        # Alternancia de filas
        "table_row_alternate_background_color": GRAY_50,
        "table_grid_color": GRAY_150,
        # Texto de las celdas en función del tipo de dato
        "table_null_color": GRAY_400,
        "table_default_color": THEME["text"],
        "table_boolean_color": DARK_BLUE,
        "table_datetime_color": DARK_ORANGE,
        "table_dict_color": DARK_PURPLE,
        "table_number_color": DARK_RED,
        "table_string_color": DARK_GREEN,
    }
)
...
THEME.update(
    {
        # Default
        "toolbar_background_color": "rgba(76, 141, 218, 0.10)",
        "toolbar_border_color": THEME["primary"],
        "toolbar_color": THEME["text"],
        # Separador
        "toolbar_separator": GRAY_300,
    }
)
...
THEME.update(
    {
        ...
        "toolbar_button_background_color_hover": BLUE_RGBA_25,
        "toolbar_button_background_color_pressed": BLUE_RGBA_50,
        "toolbar_button_color": THEME["text"],
        "toolbar_button_color_hover": THEME["primary"],
        "toolbar_button_color_pressed": THEME["primary"],
        # Iconos
        ...
        "toolbar_button_new_file_icon_color": BLUE,
        "toolbar_button_open_file_icon_color": ORANGE,
        "toolbar_button_rename_file_icon_color": PURPLE,
        "toolbar_button_save_file_icon_color": GRAY_600,
    }
)
